...
@section('title', 'Tambah Form Amanat - Admin')
            ...
            <div
                ...
                <div
                    ...
                    <div class="p-6 pb-0 mb-0 bg-white rounded-t-2xl">
                        <h6 class="text-base font-semibold leading-7 text-gray-900">Tambah Form Amanat</h6>
                                ...
                                <div class="sm:col-span-3">
                                    ...
                                    <div class="mt-2">
                                        <input type="text" name="no_letter" id="no_letter" autocomplete="no_letter"
                                            ...
                                            @error('no_letter') is-invalid @enderror value="{{ old('no_letter') }}">
                                        @error('no_letter')
                                ...
                                <div class="sm:col-span-3">
                                    ...
                                    <div class="mt-2">
                                        <input type="text" name="regarding" id="regarding" autocomplete="regarding"
                                            class="block w-full rounded-md border-0 p-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                            @error('regarding') is-invalid @enderror value="{{ old('regarding') }}">
                                        @error('regarding')
                                            <div class="mt-1 text-sm font-semibold text-red-600">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="sm:col-span-3">
                                    ...
                                    <div class="mt-2">
                                        <input type="date" name="date_letter" id="date_letter" autocomplete="date_letter"
                                            class="block w-full rounded-md border-0 p-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                            @error('date_letter') is-invalid @enderror value="{{ old('date_letter') }}">
                                        @error('date_letter')
                                            <div class="mt-1 text-sm font-semibold text-red-600">{{ $message }}</div>
                                        @enderror
                                    </div>
