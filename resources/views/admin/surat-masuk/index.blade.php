...
@section('title', 'Halaman Form Amanat - Admin')
...
@section('script')
    <script type="text/javascript">
        ...
        $(document).on('click', '.HapusSuratMasuk', function(e) {
            ...
            Swal.fire({
                    title: "Yakin ?",
                    text: `Form Amanat, dengan nomor surat ${noSurat} akan dihapus ?`,
                    icon: "warning",
