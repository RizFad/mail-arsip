...
@section('title', 'Detail Database Amanat - Pimpinan')
                    ...
                    <div class="flex-auto pb-2">
                        <div class="grid grid-cols-12 gap-3">
                                ...
                                <div class="overflow-x-auto">
                                    <table
                                        ...
                                        <thead>
                                            ...
                                            <tr>
                                                <th class="text-start px-3 py-3 border border-slate-300">Tujuan Surat</th>
                                                <td class="text-start px-3 py-3 border border-slate-300">
                                                    {{ $suratkeluar->purpose }}
                                                </td>
                                            </tr>
                            ...
                            <div class="lg:col-span-7 col-span-12 lg:order-2 order-1">
                                <iframe src="{{ asset('suratkeluar/' . $suratkeluar->file) }}" frameborder="0"
